...
public interface InscripcionCrudService {
	...
	/**
	 * Busca todos los datos deun atleta usando su dorsal y la competici�n en la que
	 * ha participado
	 * 
	 * @param idAtleta
	 * @param idCompeticion
	 ...
	 * @throws BusinessException
	 */
	AtletaInscritoDto obtenerAtletaParaComparar(int dorsal, int idCompeticion) throws BusinessException;
