...
public class InscripcionDto {
	...
	public InscripcionDto(int idCompeticion, String idAtleta, Date fechaInscripcion, Date fechaUltimoCambio,
			int idCategoria, int posicionFinal, float tiempoQueTarda, Estado estado) {
